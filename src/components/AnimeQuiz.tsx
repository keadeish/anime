...
export function AnimeQuiz(): JSX.Element {
    ...
    async function characterData() {
        ...
        const firstCharacter: characterStructure | string = characterJSON.data[20].name
        const firstAnimeImageURL: characterStructure | string = characterJSON.data[20].images.jpg.image_url
        const secondCharacter: characterStructure | string = characterJSON.data[19].name
        const secondAnimeImageURL: characterStructure | string = characterJSON.data[9].images.jpg.image_url
    ...
    return <>
        <div className="aniMangaWrapper">
            ...
            <div className="QuizBorder">
                <p className="QuizTitle"><b>Who Is More Popular?</b></p>
            </div>
